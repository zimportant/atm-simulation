define('./workbox-6f0d2936.js', ['exports'], function(t) {
  ...
  class D {
    ...
    async install({ event: t, plugins: e } = {}) {
      ...
      const c = s.map(({ cacheKey: s, url: n }) => {
        const i = this.O.get(s),
          r = this.M.get(n);
        return this.D({ cacheKey: s, cacheMode: r, event: t, integrity: i, plugins: e, url: n });
      });
    ...
    async D({ cacheKey: t, url: e, cacheMode: n, event: i, plugins: r, integrity: a }) {
  ...
  (t.CacheFirst = class {
    ...
    async C(t, e) {
      const s = await b({ request: t, event: e, fetchOptions: this.P, plugins: this.T }),
        n = s.clone(),
    ...
    (t.ExpirationPlugin = class {
      ...
      async deleteCacheAndMetadata() {
        for (const [t, e] of this.W) await self.caches.delete(t), await e.delete();
        this.W = new Map();
      }
    }),
    ...
    (t.precacheAndRoute = function(t, e) {
      !(function(t) {
        P().addToCacheList(t),
          t.length > 0 &&
            (self.addEventListener('install', W), self.addEventListener('activate', B));
      })(t),
        A(e);
    }),
